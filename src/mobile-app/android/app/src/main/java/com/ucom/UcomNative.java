...
public class UcomNative extends ReactContextBaseJavaModule {
    private static ReactApplicationContext reactContext;
    public static final String LOG_TAG = "Ucom:UcomNative";
    private static Bundle pendingBundle = null;

    public UcomNative(ReactApplicationContext context) {
        super(context);
    ...
    public void launchMainActivity(String uri) {
        ...
        Log.d(LOG_TAG, "launchMainActivity: "+ uri +" , className: "+ className );
        try {
