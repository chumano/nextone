...
import { getFCMToken, registerFBBackgroundHanlder, registerFBForegroundHandler, requestFBUserPermission } from './utils/fcm';
...
const RootApp = () => {
  ...
  useEffect(() => {
    ...
    //background
    registerFBBackgroundHanlder(handleFBCall)
