...
import { StyleSheet, View, TextInput, TouchableOpacity, Keyboard, Text, Platform, PermissionsAndroid } from 'react-native';
import { IconButton } from 'react-native-paper';

import { APP_THEME } from '../../constants/app.theme';
import {
  Asset, ImageLibraryOptions, launchCamera,
  launchImageLibrary
      ...
      <View style={styles.chatInputInnerContainer}>
        ...
        {sendBtnVisible ? (
          ...
          <View style={styles.iconButtonsContainer}>
            ...
            <View style={styles.iconButtonContainer}>
               <IconButton icon='microphone'  size={24} onPress={onToggleRecording} color={recordingEnabled?APP_THEME.colors.primary:'black'}/>
            </View>
          </View>
        )}
      </View>

      <AudioRecorder recordingEnabled={recordingEnabled} onRecorded={onAudioRecorded}/>
    </View>
  );
};
