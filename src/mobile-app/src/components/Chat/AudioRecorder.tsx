...
import { Keyboard, PermissionsAndroid, Platform, StyleSheet, Text, TouchableOpacity, View } from 'react-native';
...
const AudioRecorder: React.FC<AudioRecorderProps> = ({ recordingEnabled, onRecorded }) => {
        ...
        {recordingEnabled &&
            <View>
                ...
                <View style={styles.recordingContainer}>
                    ...
                    <TouchableOpacity style={[styles.recordingButton, { backgroundColor: '#eaeaea' }]}
                        onPressIn={onStartRecord} onPressOut={onStopRecord} >
                        <MaterialCommunityIcon name='microphone' size={60} color={APP_THEME.colors.primary} />
