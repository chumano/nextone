...
namespace MapService.Wms
{
    ...
    public class ServerCapabilities : Capabilities
    {
        ...
        public static XmlDocument GetCapabilities(Map map, Capabilities.WmsServiceDescription serviceDescription, HttpContext context)
        {
            ...
            RootNode.AppendChild(GenerateCapabilityNode(map, capabilities, serviceDescription.PublicAccessURL, context));
        ...
        private static XmlNode GenerateCapabilityNode(Map map, XmlDocument capabilities, string publicWMSUrl , HttpContext context)
        {
            string OnlineResource = "";

            if (String.IsNullOrEmpty(publicWMSUrl))
            {
                //string port = ":" + context.Connection.RemotePort;
                //OnlineResource =
                //    context.HtmlEncode("http://" + context.Request.Host  +
                //                                          context.Request.P.AbsolutePath);
                ...
                OnlineResource = WebUtility.HtmlEncode(absoluteUri);
            }
            else
            {
