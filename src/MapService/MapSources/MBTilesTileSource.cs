...
namespace MapService.MapSources
{
    class MBTilesTileSource : ITileSource
    {
        ...
        public MBTilesTileSource(TileSetConfiguration configuration)
        {
            ...
            this.contentType = MapUtils.GetContentType(this.configuration.Format); // TODO: from db metadata
        ...
        {
            var uriString = source.Replace(MapUtils.MBTilesScheme, MapUtils.LocalFileScheme, StringComparison.Ordinal);
